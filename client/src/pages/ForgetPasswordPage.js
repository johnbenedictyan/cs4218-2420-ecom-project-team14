...
const ForgetPassword = () => {
  ...
  const validateData = () => {
    ...
    if (answer.length > 100) {
      errors.answer =
        "The length of the answer can only be up to 100 characters";
    }
    return errors;
  };
      ...
      if (
        ...
        toast.error(
          error.response.data?.message ??
            "Error encountered when resetting password"
        );
      } else {
        console.log(error);
        ...
        <div className="form-container" style={{ minHeight: "90vh" }}>
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              ></input>
              {errors.newPassword && (
                <p style={{ color: "red" }} id="error-text-newPassword">
                  {errors.newPassword}
                </p>
              )}
            </div>
            <div className="mb-4">
              ...
              ></input>
              {errors.answer && (
                <p style={{ color: "red" }} id="error-text-answer">
                  {errors.answer}
                </p>
              )}
            </div>
