...
describe("ProductDetails Component", () => {
  ...
  it("correctly displays maximum price", async () => {
    ...
    expect(screen.getByText(/Price :/i)).toBeInTheDocument();
    expect(screen.getByText(/\$100,000\.99/i)).toBeInTheDocument();
  });
  ...
  it("displays related products correctly", async () => {
    ...
    expect(screen.getByText("$100,000.99")).toBeInTheDocument();
    ...
    expect(
      screen.getByText(longDesc.substring(0, 60) + "...")
    ).toBeInTheDocument();
  });
  ...
  it("renders product details with correct structure", async () => {
    ...
    expect(
      screen.getByText(/Description : This is a test product/i)
    ).toBeInTheDocument();
